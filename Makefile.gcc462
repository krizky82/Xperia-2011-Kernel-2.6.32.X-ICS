...
MODFLAGS	= -DMODULE
COMMON_OPT_FLAGS = -mfpu=neon -mtune=cortex-a8 -march=armv7-a -fgcse-lm -fgcse-sm -fsched-spec-load -fforce-addr -ffast-math -fsingle-precision-constant -ftree-vectorize -funswitch-loops
